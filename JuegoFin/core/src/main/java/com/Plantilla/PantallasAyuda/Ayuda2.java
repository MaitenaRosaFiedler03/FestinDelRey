...
import com.Plantilla.PantallasAyuda.Ayuda3;
...
public class Ayuda2 implements Screen{
    ...
    public Ayuda2 (MyGdxGame game) {
        System.out.println("ayuda ");
            this.game = game;
            guiCam = new OrthographicCamera();
            guiCam.setToOrtho(false, 800, 480);
            testTable = new Table();
            testTable.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture("Ayuda3.png"))));
		...
		game.batch.setProjectionMatrix(guiCam.combined);
            ...
            if (Gdx.input.justTouched()) {
                    ...
                    if (nextBounds.contains(touchPoint.x, touchPoint.y)) {
                            ...
                            game.setScreen(new Ayuda3(game));
                    }
            }
             game.batch.begin();
