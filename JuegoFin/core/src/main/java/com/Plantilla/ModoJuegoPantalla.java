...
public class ModoJuegoPantalla implements Screen {
        ...
        public ModoJuegoPantalla(final MyGdxGame game){
            ...
            botonModoFacil = new Rectangle(500, 95, 134, 20);
            botonModoDificil = new Rectangle(500, 120, 134, 20);
            salir = new Rectangle(450, 150, 64, 64);
            bSalir = new Texture(Gdx.files.internal("adelante.png"));
        }
